 ...
 * $Revision: 7274 $
 * $URL: http://metis.ipfn.ist.utl.pt:8888/svn/cdaq/ATCA/ATCA-IO-CONTROL/IPP/W7X_INTLCK_FP/Software/include/atca-ioc-int-ioctl.h $
 *
 */
...
#define PCIE_ATCA_IOCG_DMA_SIZE           _IOR(PCIE_ATCA_IOC_MAGIC, 41, u_int32_t)
...
#define PCIE_ATCA_IOCT_BIG_ENDIAN               _IO(PCIE_ATCA_IOC_MAGIC, 42)
#define PCIE_ATCA_IOCT_LITTLE_ENDIAN            _IO(PCIE_ATCA_IOC_MAGIC, 43)
