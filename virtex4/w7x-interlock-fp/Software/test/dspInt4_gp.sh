...
plot datafile binary format='%int%2int16%3float' every plot_dec::firstl:0:endl  \
     using  (\$0 * plot_sampl_per):(\$1  ) with lines lt 1 title '(Int  Chan 1)', \
    ...
    datafile binary format="%int%2int16%3float" every plot_dec::firstl:0:endl  \
     using  (\$0 * plot_sampl_per):(\$2  ) with lines lt 3 axes x1y2 title '(Int 16 DAC out)', \
    datafile binary format="%int%2int16%3float" every plot_dec::firstl:0:endl  \
     using  (\$0 * plot_sampl_per):(\$6 * 1.1  ) with lines lt 4 axes x1y2 title '(Float  dataDspAdd[5] )'
#    datafile binary format="%int%2int16%3float" every plot_dec::firstl:0:endl  \
